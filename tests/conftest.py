...
def make_rgb_image(path: Path, width: int = 200, height: int = 280,
                   color: tuple = (180, 100, 60)) -> Path:
...
def make_xml(path: Path, fronts: list[dict], backs: list[dict] | None = None,
             cardback_id: str = "CB001", quantity: int = 9) -> Path:
